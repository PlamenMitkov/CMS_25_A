...
namespace CMS_25_A
{
    public partial class JobDetailsForm : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'cMS_25_ADataSet.tblJobDetails' table. You can move, or remove it, as needed.
            this.tblJobDetailsTableAdapter.Fill(this.cMS_25_ADataSet.tblJobDetails);
